...
$page_id = get_the_ID();
?>
<div class="TemplateBanner temp_skill temp_CTS" style="background-image: url('<?php echo $template_banner_image; ?>')">
						...
						<?php
							if( have_rows("skill_solution_item")): 
								foreach (get_field("skill_solution_item") as $i => $item  ) {
									echo '<div class="col-12 col-sm-6 col-lg-3 col-xl my-3"><div class="skill_item_wrap"><a class="scrollspy" href="#skillRow_'.( $i + 1) .'"></a>';
...
<div class="section_content" data-aos="fade-up" data-aos-delay="50" id="skillRow_1">
	<div class="container">
						...
						<?php
							if( have_rows("skill_employability_oriented_traning_type")): 
								foreach (get_field("skill_employability_oriented_traning_type") as $i => $item  ) {
									echo '<div class="col-12 col-sm-6 col-lg my-3 employability_item_wrap"><div class="box_wrap">';
...
?>
<div class="section_content" data-aos="fade-up" data-aos-delay="50" id="skillRow_<?php echo ($i + 2); ?>">
	<div class="container">
		<div class="row justify-content-center">
