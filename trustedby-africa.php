<div class="row py-4" data-aos="fade-up" data-aos-delay="50">
    <?php if(!get_field('africa_our_client')){
        echo '<h6 class="col-12 section-heading text-center pb-3">Trusted by 400+ Customers</h6>';
    }
    ?>
	<div class="col-12">
		<div class="trustedBy">
        ...
        'tax_query' => array(
			array('taxonomy' => 'trusted_by', 'field' => 'slug', 'terms' => 'africa')));
